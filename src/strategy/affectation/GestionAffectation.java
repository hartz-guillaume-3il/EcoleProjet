...
public final class GestionAffectation {
    ...
    public GestionAffectation(StrategieAffectation strategie) { this.strategie = strategie; }

    public void changerStrategie(StrategieAffectation strategie) { this.strategie = strategie; }
